...
extern "C" {
    ...
    JNIEXPORT int Java_com_superpowered_frequencydomain_MainActivity_setPitchCent(JNIEnv *env, jobject self, jint cent);
}
...
JNIEXPORT int Java_com_superpowered_frequencydomain_MainActivity_setPitchCent(JNIEnv *env, jobject self, jint cent) {
    //return (*env)->NewStringUTF(env, "FrequencyDomain:Test");
    return audioIO->setPitchCent(cent);
    //return cent;
}